...
The GUI can be resized to a user specific size with the buttons and searchbar adapting.

Predeterment hotkeys can be changed by the user to a combination they need. 